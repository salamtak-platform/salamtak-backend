...
<body>
  <div class="email-container">
    ...
    <div class="email-body">
      <h2>Hello ${name},</h2>
      <p>Thank you for signing up with Salamtk app. To complete your registration and start using your account, please get code to ${subject}</p>
      <h2 class="activation-button">${otp}</h2>
      <p>If you did not sign up for this account, please ignore this email.</p>
      <p>Best regards,<br>Social Media Team</p>
    </div>
    <div class="email-footer">
      <p>&copy; 2026 salamtk. All rights reserved.</p>
